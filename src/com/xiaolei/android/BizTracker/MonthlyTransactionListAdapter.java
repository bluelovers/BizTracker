...
public class MonthlyTransactionListAdapter extends BaseAdapter {
	...
	public MonthlyTransactionListAdapter(Context context, View parentView,
	...
	public void loadDataAsync() {
		if (parentView != null) {
			...
			ViewFlipper viewSwitcher = (ViewFlipper) parentView
					.findViewById(R.id.viewFlipperMonthlyTransactionList);
			...
			protected Boolean doInBackground(Void... args) {
				...
				for (int i = 0; i < items.length; i++) {
					...
					double pay = DataService.GetInstance(context).getTotalPay(
							dayOfMonth, Utility.getEndTimeOfDate(dayOfMonth));
					double earn = DataService.GetInstance(context)
							.getTotalEarn(dayOfMonth,
									Utility.getEndTimeOfDate(dayOfMonth));
