 ...
 * 
 */
public class TransactionListPagerAdapter extends PagerAdapter {
	...
	public void reloadView(int position) {
		...
		if (view != null) {
			ExpandableListView lv = (ExpandableListView) view
					.findViewById(R.id.expandableListViewBizLogByDay);
			if (lv != null) {
				TransactionListCursorTreeAdapter adapter = (TransactionListCursorTreeAdapter) lv
						.getAdapter();
				if (adapter != null) {
	...
	public void destroyItem(View collection, int position, Object view) {
		...
		if (tobeRemovedView != null) {
			ExpandableListView lv = (ExpandableListView) tobeRemovedView
					.findViewById(R.id.expandableListViewBizLogByDay);
			if (lv != null) {
				TransactionListCursorTreeAdapter adpt = (TransactionListCursorTreeAdapter) lv
	...
	public Object instantiateItem(View collection, int position) {
		...
		ExpandableListView lv = (ExpandableListView) result
				.findViewById(R.id.expandableListViewBizLogByDay);
		if (lv != null && onItemClickListener != null) {
			lv.setOnItemClickListener(onItemClickListener);
		}

		TransactionListCursorTreeAdapter adpt = new TransactionListCursorTreeAdapter(
				context, result, lv, currentDate, false,
				...
				}, new OnExpandedListViewStarImageViewClickListener() {

					@Override
					public void onStarImageViewClick(ImageView imageView,
							BizLog bizLog,
							TransactionListCursorTreeAdapter listViewAdapter) {
							...
							new OnGotResultListener() {
								...
								public void onGotResult(Boolean result,
									...
									if (result == true) {
										...
										TransactionListCursorTreeAdapter adapter = (TransactionListCursorTreeAdapter) listView
												.getExpandableListAdapter();
										if (adapter != null) {
											adapter.loadDataAsync();
										}
