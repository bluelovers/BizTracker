 ...
 *
 */
public class TransactionListYearlyPagerAdapter extends PagerAdapter {
	...
	public TransactionListYearlyPagerAdapter(Activity context, Date date, int pageCount) {
	...
	public void destroyItem(View collection, int position, Object view) {
		...
		if (tobeRemovedView != null) {
			ListView lv = (ListView) tobeRemovedView
					.findViewById(R.id.listViewDaysOfMonth);
			if (lv != null) {
	...
	public Object instantiateItem(View collection, int position) {
		...
		View result = inflater.inflate(R.layout.pager_child_transaction_list_yearly, pager,
				false);
		if (!viewPositionMapping.containsKey(position)) {
		...
		ListView lv = (ListView) result.findViewById(R.id.listViewDaysOfMonth);
